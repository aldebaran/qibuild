...
.. note:: You can NOT specify optional dependencies when using qi_use_lib.

That's because it's hard to know from CMake whether the ``foo-config.cmake`` file
...
dependencies, you can do this this way:
