...
function(qi_create_insource_launcher _binary_name _trampo_name)
  cmake_parse_arguments(ARG "EXTERNAL_BINARY" "" "" ${ARGN})
  if(WIN32)
    _gen_path(_path)
    string(REPLACE "/" "\\" _dos_sdk_dir ${QI_SDK_DIR})
  else()
    if(APPLE)
  ...
  if (ARG_EXTERNAL_BINARY)
    ...
    if(WIN32)
      set(_exec_path "${_dos_sdk_dir}\\${QI_SDK_BIN}\\${_binary_name}")
    else()
      set(_exec_path "${QI_SDK_DIR}/${QI_SDK_BIN}/${_binary_name}")
    endif()
  endif()
  ...
  configure_file("${QI_TEMPLATE_DIR}/trampoline_sdk_${TARGET_ARCH}.in"
