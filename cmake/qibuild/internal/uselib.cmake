...
function(_qi_use_lib_internal name)
  ...
  foreach(_pkg ${${_key}})
    ...
    if (DEFINED ${_U_PKG}_LIBRARIES)
      list(LENGTH ${_U_PKG}_LIBRARIES _length)
      if(${_length} EQUAL 1)
        if(TARGET ${${_U_PKG}_LIBRARIES})
        # this is an imported target, we need to call find_package()
        # before using target_link_libraries()
          find_package(${_U_PKG})
        endif()
      endif()
